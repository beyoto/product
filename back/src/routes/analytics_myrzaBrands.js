...
// GET /api/analytics/views?productId=5&range=24h|7d|30d
  ...
  try {
    ...
    const result = await pool.query(
      `SELECT captured_at, views_count
       FROM views_snapshots_myrzaBrands
...
// GET /api/analytics/views-summary?range=24h|7d|30d — сумма просмотров всех товаров вместе
...
// GET /api/analytics/views-compare?productIds=1,2,3&range=24h|7d|30d — сравнение нескольких товаров
